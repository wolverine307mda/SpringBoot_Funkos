package org.example.springboot_funkos.rest.auth.services;

import org.example.springboot_funkos.rest.auth.dto.JwtAuthResponse;
import org.example.springboot_funkos.rest.auth.dto.UserSignInRequest;
import org.example.springboot_funkos.rest.auth.dto.UserSignUpRequest;
import org.example.springboot_funkos.rest.auth.exceptions.AuthSingInInvalid;
import org.example.springboot_funkos.rest.auth.exceptions.UserAuthNameOrEmailExisten;
import org.example.springboot_funkos.rest.auth.exceptions.UserDiferentePasswords;
import org.example.springboot_funkos.rest.auth.repositories.AuthUsersRepository;
import org.example.springboot_funkos.rest.auth.services.authentication.AuthenticationServiceImpl;
import org.example.springboot_funkos.rest.auth.services.jwt.JwtService;
